...
import SuggestedCircles from "@/components/Post/SuggestedCircles.vue";
    ...
    <section class="user-profile">
      ...
      <section v-if="!selectedSetting" class="user-profile">
        ...
        <div class="btn-group-vertical btn-group-profile" role="group" aria-label="Vertical button group">
          ...
          <button type="button" class="btn btn-dark" @click="updateTab('Notifications')">Create Notifications</button>
      ...
      <section v-else class="user-profile">
        <!-- <h2 class="section-title">{{ currentUsername }}'s Profile</h2> -->
        <button class="btn btn-primary btn-go-back" type="button" @click="updateTab('')">Return to My Profile</button>
